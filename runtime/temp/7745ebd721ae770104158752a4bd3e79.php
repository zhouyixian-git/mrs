<?php /*a:1:{s:50:"E:\work\wnmp\mrs\application\view\index\index.html";i:1573137980;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo url('admin/index/logout'); ?>">安全退出</a></li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('menu/index'); ?>" data-index="0">主页示例一</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="mailbox.html">
                            <i class="fa fa-envelope"></i> <span class="nav-label">信箱 </span><span class="label label-warning pull-right">16</span>
                        </a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="<?php echo url('admin/index/logout'); ?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
